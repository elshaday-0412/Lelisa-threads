      ...
      <section className="py-24 px-6 md:px-16 border-b border-[#E5E1DA] text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xs md:text-sm text-gray-600 font-light max-w-2xl mx-auto leading-relaxed">
            For over three millennia, the traditional handwoven Ethiopian dress has been a canvas of identity, spirituality, and celebration. Discover the artistry behind every Habesha Threads creation.
          </p>
        </div>
      </section>
